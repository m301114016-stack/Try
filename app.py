...
if st.session_state.step == -1:
    with st.form("consent_form"):
        ...
        st.write("""各位同學們好:此問卷目的在於了解台灣藥學生專業認同之行為，並探討相關因素之影響。
                    <br>"""我們誠摯邀請你填寫問卷，整份問卷約需花費你10分鐘的時間。本研究已通過台北醫學大學暨附屬醫院聯合人體研究倫理委員會核准，您的資料將視為機密且身分將被保密。"""
                    <br>"""若您在研究過程中有任何對本研究之疑慮，可隨時要求修正、刪除資料，亦可以選擇退出研究。
                    <br>再次感謝您的協助。
                    <br> 問卷填寫完後，若民有意願領取數位禮券，請留下民常用的email，經研究人員確定為有效問卷後，將依前200名填寫順序寄送。""")
